  ...
  return (
    <>
        ...
        <div className="nr--signIN--main">
            <form  className="nr--signIn--right">
                ...
                <div className="nr--sign--in--text--inputs">
                    ...
                    <div className="nr--signIn--right--inputs">
                        <div className="nr--signIn--right--inputs--email">
                            ...
                            <input type="email" name='email' value={formData.email} id="nr--email" placeholder="Enter Your Email" required onChange={handleChange} />
                        </div>
                        <div className="nr--signIn--right--inputs--email">
                            <label htmlFor="nr--pass">Password</label>
                            <input type="password" id="nr--pass" placeholder="Enter Your Password" value={formData.password} name='password' required onChange={handleChange} />
                        </div>
                    </div>
                ...
                <div className="nr--log--in--google--dont">
                    <a href="#" className="nr--log--with--google">
                    ...
                    <Link to={'/signup'} className="nr--dont--ac">Don’t have an account? <span>Sign up for free</span></Link>
